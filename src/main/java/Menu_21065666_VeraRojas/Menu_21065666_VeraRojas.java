...
public class Menu_21065666_VeraRojas {
    ...
    private Option_21065666_VeraRojas makeNewOption(UserInterface_21065666_VeraRojas user) {
        ...
        System.out.print("Ingrese el numero identificador o code: ");
        optionCode = input.nextInt();
        input.nextLine();
        System.out.print("Ingrese el mensaje de la opcion: ");
        optionMessage = input.nextLine();
        System.out.print("Ingrese el id del chatbot al cual apunta esta opcion (chatbotCodeLink): ");
        optionChatbotCodeLink = input.nextInt();
        input.nextLine();
        System.out.print("Ingrese el id del flow al cual apunta esta opcion (initialFlowCodeLink): ");
        optionInitialFlowCodeLink = input.nextInt();
        input.nextLine();
        System.out.print("Ingrese la cantidad de keywords a ingresar: ");
    ...
    private Flow_21065666_VeraRojas makeNewFlow(UserInterface_21065666_VeraRojas user) {
        ...
        input.nextLine();
        System.out.print("Ingrese el nombre y mensaje del flujo: ");
        flowNameMsg = input.nextLine();
        System.out.print("Ingrese la cantidad de opciones a crear: ");
    ...
    private Chatbot_21065666_VeraRojas makeNewChatbot(UserInterface_21065666_VeraRojas user){
        ...
        System.out.print("Ingrese el mensaje de bienvenida: ");
        chatbotWelcomeMessage = input.nextLine();
        System.out.print("Ingrese el el identificador del flujo inicial: ");
        chatbotStartFlowID = input.nextInt();
        input.nextLine();
        System.out.print("Ingrese la cantidad de flujos a crear: ");
                    ...
                    switch (tipoModificacionChatbot) {
                        ...
                        case 2:
                            do {
                                ...
                                System.out.print("INGRESE EL NuMERO IDENTIFICADOR DEL FLUJO: ");
                                flowID = input.nextInt();
